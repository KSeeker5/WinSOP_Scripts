...
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/e/e/3/ee322649-7f38-4553-a26b-a2ac40a0b205/WindowsServer2003-KB958644-x86-ENU.exe','MS08-067_2003.exe')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/F/5/7/F572FDA0-1082-43BF-9927-D89CD78C0DA4/WindowsServer2003-KB2592799-x86-ENU.exe','MS11-080_2003.exe')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/0/B/5/0B5C6A96-39FA-4A64-819D-30F1674395F4/WindowsServer2003-KB2989935-x86-ENU.exe','MS14-070_2003.exe')"
) else if %Patch%==2 (
echo "Downloading -MS09-050 & MS16-032-"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/D/E/6/DE69BD2A-6C70-4716-BD73-E933CC884F23/Windows6.0-KB975517-x64.msu','MS09-050_2008.msu')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/F/2/D/F2D919E1-2E08-4ACF-AEDB-575AD146750E/Windows6.1-KB3139914-x64.msu','MS16-032_2008R2.msu')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/2/B/4/2B4810AE-7F93-49C6-BED7-4AD293AA0F7F/Windows6.1-KB3139914-x86.msu','MS16-032_Win7.msu')"
) else if %Patch%==3 (
echo "Downloading -MS08-067, MS11-080, MS14-070, MS09-050, & MS16-032-"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/e/e/3/ee322649-7f38-4553-a26b-a2ac40a0b205/WindowsServer2003-KB958644-x86-ENU.exe','MS08-067_2003.exe')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/F/5/7/F572FDA0-1082-43BF-9927-D89CD78C0DA4/WindowsServer2003-KB2592799-x86-ENU.exe','MS11-080_2003.exe')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/0/B/5/0B5C6A96-39FA-4A64-819D-30F1674395F4/WindowsServer2003-KB2989935-x86-ENU.exe','MS14-070_2003.exe')"
powershell -command "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/D/E/6/DE69BD2A-6C70-4716-BD73-E933CC884F23/Windows6.0-KB975517-x64.msu','MS09-050_2008.msu')"
